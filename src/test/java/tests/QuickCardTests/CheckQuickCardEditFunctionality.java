...
public class CheckQuickCardEditFunctionality extends BaseTest {
    ...
    public void checkQuickCardReviewFunctionality() throws Exception {
        ...
        softAssert.assertEquals(quickCardPage.getQuickCardInfo(BookmakerApiCalls.bookmakerName,1),
                new ArrayList<>(Arrays.asList("5.9 / 10", "Text-to-display-test", "REVIEW", "WEBSITE")));
        quickCardApiCalls.updateQuickCardInfo(BookmakerApiCalls.bookmakerId);
        mainPage.refreshPage();
        softAssert.assertEquals(quickCardPage.getQuickCardInfo(BookmakerApiCalls.bookmakerName,1),
                new ArrayList<>(Arrays.asList("5.9 / 10", "Text-to-display-test-edit", "REVIEW", "WEBSITE")));
        softAssert.assertEquals(quickCardPage.getQuickCardTags(BookmakerApiCalls.bookmakerName), new ArrayList<>(Collections.singletonList("CS:GO")));
