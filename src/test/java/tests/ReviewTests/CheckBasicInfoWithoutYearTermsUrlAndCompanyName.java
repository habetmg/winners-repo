...
public class CheckBasicInfoWithoutYearTermsUrlAndCompanyName extends BaseTest {
    ...
    public void checkBookmakerBasicInfoWithoutOptionalFields() throws Exception {
        ...
        Assert.assertEquals(reviewPage.getContentBySectionName("Basic Info"), "Main Review-overview\n" +
                "Basic Info\n" +
                "Company Name\n" +
                "Company-Name-Test\n" +
                "Year Established\n" +
                "2021\n" +
                "Jurisdiction\n" +
                "Afghanistan, Austria, Bangladesh\n" +
                "Website Terms & Conditions\n" +
                "https://winners.bet/\n" +
                "Products\n" +
                "Esports, Sports, Live Casino, Pool Betting\n" +
                "SHOW LESS");
        System.out.print("tgjgjgjgg" + bookmakerApiCalls.addBookmakerProfileWithoutYearCompanyTermsUrl(BookmakerApiCalls.bookmakerId));
